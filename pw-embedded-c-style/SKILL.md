...
description: 嵌入式 C 代码风格助手, 基于 51 单片机教学项目的代码规范。用于创建符合嵌入式开发规范的项目结构, 优化代码风格, 提供硬件驱动模板。适用于 51 单片机、STM32 等嵌入式 C 项目开发。
---
...
// 正确: 使用模块前缀或 static
static unsigned char uartFlag;  // 仅本文件可见
extern unsigned char g_systemFlag;  // 全局共享
```
